...
Return ONLY valid JSON with these fields:
{
  ...
  "customerNote": "STRICT RULES: (1) One to two sentences maximum. (2) Warm and operator-to-operator — no corporate language, no exclamation marks. (3) Reference the actual items quoted by model code or category — e.g. 'the EPC-1011E2' or 'a 10-tray combi'. (4) Never state or imply a spec that is not explicitly present in the QUOTE ITEMS data above — if unsure of a detail, stay general ('a strong setup for a high-volume kitchen') rather than risk a wrong claim. (5) No over-promising — not 'perfect', not 'best on the market'. Confident and grounded. (6) End with, or follow with, a short fixed phrase: 'All prices ex GST and include full manufacturer warranty.' Example output: 'Great setup for a high-volume service kitchen — the EPC-1011E2 is a workhorse combi that handles 10-tray GN1/1 throughput reliably. All prices ex GST and include full manufacturer warranty.'",
  ...
  try {
    ...
    return {
      approved: true,
      flags: [],
      customerNote: 'Thanks for your enquiry — here\'s your itemised quote below. All prices ex GST and include full manufacturer warranty.',
