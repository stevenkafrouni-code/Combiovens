  ...
  const html = baseTemplate(`
    ...
    <table class="table">
      <tbody>
        ...
        <tr><td colspan="3" style="text-align:right;color:#6b6b6b">Freight</td><td class="num" style="color:#6b6b6b">Passed on at cost — confirmed within 24hrs</td></tr>
    ...
    <div style="text-align:center;margin:32px 0">
      <a href="https://www.combiovens.com.au/api/checkout?quoteId=${quote.quoteId}" class="btn" style="font-size:16px;padding:18px 48px">Pay Now — ${formatCurrency(quote.total * 1.1)} inc GST</a>
      <p style="font-size:12px;color:#6b6b6b;margin-top:12px">Secure payment via Stripe · Card accepted · Freight confirmed within 24hrs</p>
    </div>
    ...
    <div class="box" style="margin-top:24px;border-color:#e0e0e0">
      <div class="label">Freight</div>
      <p style="margin:8px 0 0;font-size:14px;color:#333333">Freight is <strong>passed on at cost — no markup.</strong> We'll confirm your exact freight cost within 24 hours of your order and send a updated total before processing payment.</p>
      ...
      <div style="margin-top:10px;font-size:13px;color:#555555">
        <strong>Delivery requirements noted:</strong>
      ...
      </div>` : '<div style="margin-top:6px;font-size:13px;color:#888">Standard ground floor delivery.</div>'}
    </div>

    <p style="font-size:13px;color:#6b6b6b">This quote is valid for 14 days. Any questions — call us on ${PHONE}. We run on hospo hours.</p>
  `);
