...
async function sendQuoteToCustomer({ quote, lines, claudeNote }) {
  ...
  const html = baseTemplate(`
    ...
    <div style="background:#fff8f0;border:1px solid #f5d9b8;border-radius:3px;padding:14px 18px;margin:24px 0 8px;font-size:14px;color:#7a4a1a">
      <strong>Note:</strong> This quote does not include freight. Freight is passed on at cost — no markup. You can pay now and we'll invoice freight separately, or request a freight quote first.
    </div>
    ...
    <table style="width:100%;margin:16px 0 8px;border-collapse:collapse">
      <tr>
        <td style="width:50%;padding-right:8px">
          ...
          <p style="font-size:11px;color:#999;text-align:center;margin:6px 0 0">Equipment only · Freight invoiced separately</p>
        </td>
        <td style="width:50%;padding-left:8px">
          ...
          <p style="font-size:11px;color:#999;text-align:center;margin:6px 0 0">We'll confirm cost within a few hours</p>
        </td>
      </tr>
    </table>
