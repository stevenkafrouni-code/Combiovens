...
interface RemoveApiKeyResponseSuccess {
}
...
type DomainRegion = 'us-east-1' | 'eu-west-1' | 'sa-east-1';
...
type VerifyDomainsResponseSuccess = Domain[];
...
declare class Resend {
    ...
    put<T>(path: string, entity: any, options?: PutOptions): Promise<{
        data: T | null;
        error: ErrorResponse | null;
    }>;
    patch<T>(path: string, entity: any, options?: PatchOptions): Promise<{
        data: T | null;
        error: ErrorResponse | null;
    }>;
